...
<html lang="en">
<head>
    <title>Контакт Nashi v Katowice</title>
    <meta charset="utf-8">
    ...
    <link rel="stylesheet" type="text/css" href="{{asset('css/styles/contact.css')}}">
...
<div class="super_container">
    ...
    <div class="home">
        <div class="home_background parallax-window" data-parallax="scroll" style="background-image:url({{asset('images/regular.jpg')}})" data-speed="0.8"></div>
                        ...
                        <div class="post_comment">
                            <div class="contact_form_container">
                                <form method="post" action="contact">
                                    @csrf
                                    <input type="text" class="contact_input contact_input_name" placeholder="Имя и Фамилия" required="required">
                                    <input name="email" type="email" class="contact_input contact_input_email" placeholder="Ваш Email" required="required">
                                    <textarea class="contact_text" placeholder="Напишите нам" required="required"></textarea>
                                    @error('email')
                                    <span class="invalid-feedback" role="alert"><strong>{{ $message }}</strong></span>
                                    @enderror
                                    <button style="background-color: #ff8525; color: white" type="submit" class="contact_button">Отправить</button>
