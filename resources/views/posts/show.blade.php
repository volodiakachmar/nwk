...
<head>
    ...
    <link href="{{asset('css/styles/archive/font-awesome.min.css')}}" rel="stylesheet" type="text/css">
    <link rel="stylesheet" type="text/css" href="{{asset('css/styles/post.css')}}">
    <link rel="stylesheet" type="text/css" href="{{asset('css/styles/post.css')}}">
    ...
    <link rel="stylesheet" href="{{asset('css/styles/styles/default.css')}}">
    <style>
...
<div class="super_container">
    <header style="background-color: black; opacity: 0.9; max-height: 80px; display: flex; align-items: center" class="header">
        <div class="container">
            <div class="row">
                <div class="col">
    ...
    <div class="home" style="height: 30vh">
        <div class="home_background parallax-window"  style="background-image:url({{asset('/images/bg_post/bg_1.png')}})"  data-speed="0.8"></div>
        <div class="home_content">

            <div style="color: white; display: flex; align-content: center; justify-content: center; margin-top: 100px" class="post_title">{{$post->title}}</div>
        </div>
    </div>
    ...
    <div class="page_content">
        <div class="container">
            ...
            <div class="max-w-screen-xl mx-auto">
                <main style="margin-top: 300px;" class="mt-10">

                    <div class="mb-4 md:mb-0 w-full max-w-screen-md mx-auto relative" style="height: 24em;">
                        <div class="absolute left-0 bottom-0 w-full h-full z-10"
                             style="background-image: linear-gradient(180deg,transparent,rgba(0,0,0,.7));"></div>
                        <img style="max-width: 100%; height:auto; max-height: 340px" src="{{asset('storage/'.Str::substr($post->image_1_title,7))}}" class="absolute left-0 top-0 w-full h-full z-0 object-cover" />
                        <div class="p-4 absolute bottom-0 left-0 z-20">
                            <h2 class="text-4xl font-semibold text-gray-100 leading-tight">
                                {{substr($post->under_photo_text, 0, 100)}}
                            </h2>
                            <div class="flex mt-3">
                                <div>
                                    <p class="font-semibold text-gray-200 text-sm">Nashi v Katowice</p>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="px-4 lg:px-0 mt-12 text-gray-700 max-w-screen-md mx-auto text-lg leading-relaxed">
                        ...
                        <p class="pb-6">{{$post->description_1}}</p>

                        <p class="pb-6">{{$post->description_2}}</p>

                        <p class="pb-6">{{$post->description_3}}</p>
                        <div class="border-l-4 border-gray-500 pl-4 mb-6 italic rounded">
                            {{$post->description_4}}
                        </div>
                        <h1 style="margin-top: 60px; margin-bottom: 30px">Написать комментарий<h1>
