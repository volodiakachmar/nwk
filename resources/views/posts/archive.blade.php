...
<head>
    ...
    <!-- Title -->
    <title>Новости Nashi v Katowice</title>

    <!-- Favicon -->
    <link rel="icon" href="img/core-img/favicon.ico">
    <link href="https://unpkg.com/tailwindcss@^1.0/dist/tailwind.min.css" rel="stylesheet">
    <!-- Stylesheet -->
    <link rel="stylesheet" href="{{asset('css/styles/archive/style.css')}}">
    <link rel="stylesheet" href="{{asset('css/styles/archive/archive.css')}}">
...
<section class="breadcrumb-area bg-overlay" style="background-image:url({{asset('/images/bg_post/bg_1.png')}}); height: 100vh">
    <div class="container h-100">
        <div class="row h-100 align-items-center">
            <div class="col-12">
                <div class="breadcrumb-content">
                    <h2 style="margin-top: 100px">Новости</h2>
                </div>
            </div>
        </div>
    </div>
...
<!-- component -->
    <div class="container my-12 mx-auto px-4 md:px-12">
        <div class="flex flex-wrap -mx-1 lg:-mx-4 pr-20">
            @foreach($posts as $post)
            <div class="my-1 px-1 w-full md:w-1/2 lg:my-4 lg:px-4 lg:w-1/3" >
                <article style="max-height: 470px" class="overflow-hidden rounded-lg shadow-lg">

                    <a style="max-height:100px" href="{{route('posts.show', $post)}}">
                        <img style="max-height: 350px" class="" src="{{asset('storage/'.Str::substr($post->image_1_title,7))}}">
                    </a>
                  <hr>
                    <header class="flex items-center leading-tight p-2 md:p-4">
                        <h1 class="text-lg">
                            <a style="text-align: center; display: flex; text-decoration: none;align-items: center; justify-content: center; padding-top: 15px; padding-left: 15px; font-size: 17px" class="no-underline hover:underline text-black" href="{{route('posts.show', $post)}}">
                    ...
                    <footer class="flex items-center justify-between leading-none p-2 md:p-4">
                        <a class="flex items-center no-underline hover:underline text-black" href="{{route('posts.show', $post)}}">

                            <p class="ml-2 text-sm">

                            </p>
                        </a>
                        <a class="no-underline text-grey-darker hover:text-red-dark" href="{{route('posts.show', $post)}}">
